...
#    ax.plot( [ 0.0, dsh ] , zeros , zeros , 'r--' , linewidth=_linwdth ) # , alpha=0.5 )
    ax.plot( [ -1.0, 0.0 ] , zeros , zeros , 'r-' , linewidth=_linwdth ) # , alpha=0.5 )
    ax.plot( [ 0.0, 1.75 ] , zeros , zeros , 'k-' , linewidth=_linwdth ) # , alpha=0.5 )
    dsh=0.18
