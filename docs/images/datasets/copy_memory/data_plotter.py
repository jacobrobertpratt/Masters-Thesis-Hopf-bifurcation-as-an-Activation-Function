...
#        exit(0)
        ...
        idx = 5
        fig.suptitle('Copy Memory | Sequence Length '+str(time_steps))
        fig.supxlabel('Time ---->')
        ...
        plt.savefig( './cpymem_example.png' , dpi=1200 , transparent=True , bbox_inches='tight', pad_inches = 0 )
        plt.show()
